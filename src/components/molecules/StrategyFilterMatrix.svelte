...
<div
    class="lg:w-[260px] glass-card p-4 shadow-elevated bg-surface/30 flex flex-col justify-between gap-3 shrink-0"
>
    ...
    <div class="flex flex-col gap-2">
        ...
        <CyberRangeSlider
            ...
            onplus={() =>
                (marketStore.filterMinVol = Math.min(1000000, marketStore.filterMinVol + 10000))}
            onminus={() =>
